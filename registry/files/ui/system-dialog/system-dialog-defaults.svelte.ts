/**
 * jixoai system-dialog family Defaults
 * (registry/files/ui/system-dialog/system-dialog-defaults.svelte.ts,
 * context-defaults-economy task 3.2, 2026-09-03).
 *
 * The system-dialog family's SINGLE declared ambient contract — one
 * `SystemDialogDefaults` object covering every vocabulary-hit style
 ...
 *                 the kbd mode (r11): system-dialog-action is absent
 ...
 *                 opinion (fleet law).
 *
 * Consumer mapping: system-dialog-content resolves { variant };
 * system-dialog-action resolves { actionVariant: variant } — each
 ...
 * system-dialog-content.svelte's Props and this contract share it).
 */
export const alertDialogSurfaceVariantSlot = defineLiteralSlot(['solid', 'acrylic', 'auto'], 'auto');
export type SystemDialogSurfaceVariant = ReturnType<typeof alertDialogSurfaceVariantSlot>;
