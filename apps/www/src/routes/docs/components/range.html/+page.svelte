...
<!-- keyboard is the platform's: ←→/↑↓ step · Home/End jump ·
     PageUp/PageDown stride · RTL mirrors with zero branches -->
...
>
  ...
  <div data-reveal="">
    <ComponentCanvas
      title="range"
      description="A real input[type=range] underneath — drag, tap-to-jump, ←→/↑↓/Home/End/PageUp/Down and RTL are the engine's own, engine-tested; the component carries the paint, the label row, the readout and the error law."
      ...
      {#snippet playground()}
        <PlayFields>
          ...
          <PlayHelp>
            ...
            PageUp/PageDown stride. Decimal steps snap at the step's precision.
          </PlayHelp>
        </PlayFields>
      {/snippet}
    </ComponentCanvas>
