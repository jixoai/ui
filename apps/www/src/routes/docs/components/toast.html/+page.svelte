...
<div class="mx-auto flex w-full max-w-[90rem] flex-col gap-8 px-4 pb-10 sm:px-6 lg:px-8">
  <div id="types" data-reveal=""><SectionCard family="types" headerRegion="types" eyebrow="types" title="Toast variants" summary="Tones share the tone law (border + title color); assertive switches the live-region role; duration 0 is sticky.">
    <div class="grid gap-4 sm:grid-cols-3">
      <div class="border border-border p-4"><PressButton onclick={() => toast.api.push({ title: 'Deployed', description: 'default tone · polite' })}>default</PressButton></div>
      <div class="border border-border p-4"><PressButton onclick={() => toast.api.push({ title: 'Synced', description: 'primary tone · polite', tone: 'primary' })}>primary</PressButton></div>
      <div class="border border-border p-4"><PressButton onclick={() => toast.api.push({ title: 'Build failed', description: 'destructive · assertive · sticky', tone: 'destructive', assertive: true, duration: 0 })}>destructive</PressButton></div>
    </div>
  </SectionCard></div>
