    ...
    >
      ...
      {#snippet playground()}
        <p class="text-muted-foreground text-pretty text-[11.5px] leading-5">
          ...
          reduced motion keeps the blur and fades, killing only the translate. On the vertical
          axis the progressBlur ladder yields to the shadow veil (the ladder is inline-only).
