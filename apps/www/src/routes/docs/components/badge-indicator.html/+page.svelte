...
<div class={cx(rt.shellFlush)}>
  ...
  <div id="api" data-reveal=""><SectionCard family="api" headerRegion="api" eyebrow="api" title="API" summary="Seven props; dot beats count, zero hides honestly."><PropsTable universal props={[{ name: 'dot', type: 'boolean', default: '—', description: 'The presence idiom — beats count when only presence matters.' }, { name: 'count', type: 'number', default: '—', description: 'The count idiom; hidden at 0 unless showZero.' }, { name: 'overflow', type: 'number', default: '99', description: 'Cap before "n+".' }, { name: 'showZero', type: 'boolean', default: 'false', description: 'Render count=0 instead of hiding.' }, { name: 'children', type: 'Snippet', default: '—', description: 'What the indicator rides on; omitted = standalone chip.' }, { name: 'label', type: 'string', default: "'new activity'", description: 'Accessible name for the dot (required in dot mode).' }, { name: 'class', type: 'string', default: "''", description: 'Forwarded to the wrapper/standalone element.' }]} /></SectionCard></div>
</div>
