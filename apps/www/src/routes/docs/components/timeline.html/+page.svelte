...
${close}
  ...
  const universalUsage = `<Timeline defaultValue={1} size={18} density="small">…</Timeline>`;
  const universalFiles: TreeFile[] = [
    { name: 'src/lib/ui/timeline-universal.svelte', content: universalUsage },
  ];
</script>
