<script lang="ts">
  ...
  import TabsList, { blurSlide, progressBlur } from '$lib/ui/tabs/tabs-list.svelte';
    ...
    >
      <div class="flex w-full max-w-2xl flex-col gap-7">
        ...
        <div class="flex flex-col gap-2.5">
          ...
          <span class="text-muted-foreground text-[12px]">the progressive-blur ladder veils both edges — twin grid bands over the run, gated and faded exactly like the chevrons.</span>
        </div>
      </div>
    </SectionCard>
  </div>
