  ...
  <div id="layouts" data-reveal="">
    ...
    >
      <div class="flex w-full max-w-2xl flex-col gap-7">
        ...
        <div class="flex flex-col gap-2.5">
          <span class="font-nav text-primary text-[11px] uppercase tracking-[0.24em]">scroll · scrollEffect=blur+slide</span>
          <Tabs value="gamma">
            <TabsList layout="scroll" scrollEffect="blur+slide" class="max-w-md">
              <TabsTrigger value="alpha">alpha</TabsTrigger>
              <TabsTrigger value="beta">beta</TabsTrigger>
              <TabsTrigger value="gamma">gamma</TabsTrigger>
              <TabsTrigger value="delta">delta</TabsTrigger>
          ...
          <span class="text-muted-foreground text-[12px]">triggers blur, fade and slide as they slip under the run's edges — a view()-timeline per trigger; the radius and distance live on css vars.</span>
        </div>
        <div class="flex flex-col gap-2.5">
          ...
          <span class="text-muted-foreground text-[12px]">the progressive-blur ladder veils both edges — twin grid bands over the run, gone while it cannot scroll.</span>
        </div>
      </div>
    </SectionCard>
  </div>
