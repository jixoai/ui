...
<div class="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
  ...
  <div class="flex flex-col gap-3 border border-border/60 p-4">
    ...
    <span class="text-muted-foreground text-[12px]">the liquid lens — use:liquidGlass(liquid()) mounts kube's refraction chain over the pill; the retired noise SVG is gone, frost stands where url() backdrop-filters are unsupported.</span>
  </div>
  <div class="flex flex-col gap-3 border border-border/60 p-4">
