    ...
    <ComponentCanvas
      ...
      <div class={cx(rt.tcGrid)}>
        <article id="toc-workbench-article" class={cx(rt.wFull, rt.shellCol)}>
          ...
          <section id="toc-usage" class={cx(rt.flex, rt.col, rt.gap16)}>
            <h2 data-doc-demo-heading="" class={cx(rt.fontNav, rt.tcHeading, rt.trackTight)}>usage</h2>
