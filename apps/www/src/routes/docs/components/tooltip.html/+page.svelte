...
<div class="grid w-full gap-4 sm:grid-cols-3">
  ...
  const universalUsage = `<Tooltip text="level1 · the default">…</Tooltip>
<Tooltip text="level3" elevation="level3">…</Tooltip>
<Tooltip text="4dp" elevation={4}>…</Tooltip>`;
  const universalFiles: TreeFile[] = [
    { name: 'src/lib/ui/tooltip-universal.svelte', content: universalUsage },
  ];
  ...
  <div id="types" data-reveal=""><SectionCard family="types" headerRegion="types" eyebrow="types" title="Tooltip variants" summary="Six placements across the anchored sides; the arrow opts into a notch cut from the bubble itself.">
    <ComponentCanvas title="tooltip · variants" stage="fill" files={tooltipTypesFiles}>
      <div class={cx(rt.gridSm3, rt.wFull)}>
        <div class={cx(rt.panel)}><Tooltip text="The default anchored side"><PressButton variant="outline">top</PressButton></Tooltip></div>
        <div class={cx(rt.panel)}><Tooltip text="For toolbar bottoms" placement="bottom"><PressButton variant="outline">bottom</PressButton></Tooltip></div>
        <div class={cx(rt.panel)}><Tooltip text="Corner aim through the notch" arrow placement="top-end"><PressButton variant="outline">arrow · top-end</PressButton></Tooltip></div>
      </div>
    </ComponentCanvas>
  </SectionCard></div>
