      ...
      >
        <div class={cx(rt.col20)}>
          ...
          <p class={cx(rt.para)}>
            ...
            .dark island cannot re-derive it (measured frozen), and root-level dark does not
            reach the paint either — the alias re-derives at :root (html's var flips) but
            the strip's ink holds oklch(0 0 0), twice measured: frozen everywhere. Physics
            vs pinned tokens — measured at the PAINT, not the var read.
          </p>
          <p class={cx(rt.para)}>
