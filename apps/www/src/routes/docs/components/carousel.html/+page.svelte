...
<div class={cx(rt.shellFlush, rt.flex, rt.col, rt.gap32)}>
  <div id="types" data-reveal=""><SectionCard family="types" headerRegion="types" eyebrow="types" title="Carousel variants" summary="slideWidth is the one geometric decision: page one-at-a-time or peek the neighbors; dots are optional.">
    <div class={cx(rt.caGrid)}>
      <div class={cx(rt.panel)}>
        <p class={cx(rt.eyebrow, rt.inkMuted, rt.mb8)}>one-at-a-time</p>
        <p class={cx(rt.body13)}><code class={cx(rt.inkAccent)}>slideWidth="100%"</code> (default) — each slide fills the track; snap pages cleanly.</p>
      </div>
      <div class={cx(rt.panel)}>
        <p class={cx(rt.eyebrow, rt.inkMuted, rt.mb8)}>peeking</p>
        <p class={cx(rt.body13)}><code class={cx(rt.inkAccent)}>slideWidth="60%"</code> / any CSS length — neighbors peek, snap still pages.</p>
      </div>
      <div class={cx(rt.panel)}>
        <p class={cx(rt.eyebrow, rt.inkMuted, rt.mb8)}>dots off</p>
        <p class={cx(rt.body13)}><code class={cx(rt.inkAccent)}>dots={false}</code> hides the dot row; the prev/next arrows stay.</p>
      </div>
    </div>
  </SectionCard></div>
