...
<div class="overflow-x-auto">
  ...
  const universalUsage = `<HeroSection density="medium">…</HeroSection>`;
  const universalFiles: TreeFile[] = [
    { name: 'src/lib/ui/hero-section-universal.svelte', content: universalUsage },
  ];
