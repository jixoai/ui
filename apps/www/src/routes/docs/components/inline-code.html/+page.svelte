...
>
  ...
  <aside class="jx-toc-aside lg:order-2" aria-label="On this page">
    <Toc outline={{ root: '#inline-code-content', levels: [2] }} title="on this page" scrollRoot=".jx-shell-body" />
  </aside>

  <div id="inline-code-content" class="flex min-w-0 flex-col gap-8 max-lg:pt-[68px] lg:order-1">
    <div data-reveal="">
      <SectionCard
        headingLevel={1}
        tone="hero"
      ...
      >
        <div class="flex flex-col gap-5">
          <div class="flex flex-wrap items-center gap-3 text-[13.5px]">
            ...
            <InlineCode class="[--jx-tonal:var(--success)]">tonal · injected success</InlineCode>
          </div>
