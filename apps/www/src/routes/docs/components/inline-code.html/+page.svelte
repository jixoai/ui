...
>
  <div class={cx(rt.shellCol)}>
      ...
      >
        <div class={cx(rt.col12, rt.text135)}>
          ...
          <p>
            ...
            <InlineCode lang="svelte" class={cx(rt.ilMs1)}>{'{#each list as item (item.id)}{/each}'}</InlineCode>
            too.
          </p>
          <p class={cx(rt.inkMuted)}>
            <InlineCode>npm install @jixoai/ui</InlineCode> and
            <InlineCode class={cx(rt.ilMs1)}>{"{ name: 'jixoai' }"}</InlineCode> were auto-detected — the
    ...
    <div id="inline-code-variants" data-reveal="">
      ...
      >
        <div class={cx(rt.flex, rt.col, rt.gap16)}>
          ...
          >
            <div class={cx(rt.wrapRow12, rt.text135)}>
              <InlineCode>fused · the page ground</InlineCode>
              <InlineCode variant="tonal">tonal · neutral default</InlineCode>
              <InlineCode variant="outline">outline · structural</InlineCode>
              <InlineCode variant="tonal" class="jx-hue-success">tonal · injected success</InlineCode>
            </div>
            <div class={cx(rt.wrapRow12, rt.ilRadius, rt.bgMuted, rt.p16, rt.text135)}>
              <InlineCode>fused over a tonal ground</InlineCode>
              <InlineCode variant="tonal">tonal</InlineCode>
              <InlineCode variant="outline">outline</InlineCode>
            </div>
            <div
              class={cx(rt.wrapRow12, rt.ilRadius, rt.p16, rt.text135, rt.ilStripe)}
            >
              <InlineCode>fused over a pattern</InlineCode>
              <InlineCode variant="tonal">tonal</InlineCode>
              <InlineCode variant="outline">outline</InlineCode>
        ...
        <div class={cx(rt.flex, rt.col, rt.gap20)}>
          <div class={cx(rt.grid760b)}>
            <div class={cx(rt.col12)}>
              <h3 class={cx(rt.fontNav, rt.text13, rt.trackTight)}>per instance — the backend prop</h3>
              <CodeBlock code={engineUsage} lang="svelte" meta="per-instance" />
            </div>
            <div class={cx(rt.col12)}>
              <h3 class={cx(rt.fontNav, rt.text13, rt.trackTight)}>subtree default — the context lane</h3>
          ...
          <p class={cx(rt.bodyMuted)}>
            ...
            <code class={cx(rt.inkAccent)}>HIGHLIGHT_KEY</code> + the structural type. Vite hosts owe
            microlighter its two bundler lines — dev excludes it from the optimizer
            (<code class={cx(rt.inkAccent)}>optimizeDeps: {'{ exclude: [\'microlighter\'] }'}</code>),
            builds emit its <code class={cx(rt.inkAccent)}>dist/grammars/*.js</code> next to the engine
            ...
            <a href="/docs/components/code-card.html#code-card-engines" class={cx(rt.linkAccent)}>code-card page</a>.
          </p>
        </div>
      </SectionCard>
    </div>
    ...
    <div id="inline-code-detection" data-reveal="">
      ...
      >
        <div class={cx(rt.flex, rt.col, rt.gap20)}>
          <table class={cx(rt.wFull, rt.maxWXl, rt.text125)}>
            <caption class={cx(rt.srOnly)}>what the fingerprint detector answers for representative snippets</caption>
            <tbody>
              {#each detectionSamples as [expected, code] (code)}
                <tr class={cx(rt.tBorder)}>
                  <th scope="row" class={cx(rt.bBorder, rt.px8, rt.py6, rt.textLeft, rt.weightNormal, rt.inkMuted)}>{code}</th>
                  <td class={cx(rt.bBorder, rt.px8, rt.py6)}>
          ...
          <div>
            <p class={cx(rt.mb8, rt.text125, rt.inkMuted)}>
              The candidate set mirrors the highlight engines' curated grammars (ids + aliases):
            </p>
            <div class={cx(rt.flex, rt.maxW2xl, rt.wrap, rt.gap6)}>
    ...
    <div id="inline-code-modifiers" data-region="inline-code-modifiers" data-family="inline-code-modifiers" data-reveal="">
      ...
      >
        <div class={cx(rt.flex, rt.wFull, rt.maxWXl, rt.col, rt.gap16, rt.text135)}>
          ...
          <div class={cx(rt.wrapRow12, rt.tBorder, rt.pt16)}>
            <span class={cx(rt.microEyebrow, rt.inkMuted)}>driven by the playground</span>
        ...
        {#snippet playground()}
          <PlayFields>
            ...
            <PlayHelp>
              ...
              <a href="/docs/components/text.html#modifiers" class={cx(rt.linkAccent)}>text page's modifier playground</a>.
    ...
    <div id="types" data-reveal="">
      <SectionCard eyebrow="types" title="The three language paths" summary="Plain stays plain forever; an explicit lang is trusted as-is; auto asks the heuristic. All three render the same chip before any JavaScript runs.">
        <div class={cx(rt.wrapRow12, rt.text135)}>
          ...
          <span class={cx(rt.inkMuted)}>·</span>
