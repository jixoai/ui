  ...
  <div class={cx(rt.shellCol)}>
      ...
      >
        <div class={cx(rt.col12)}>
          ...
          <div
            ...
            class={cx(rt.rowC12, rt.frame, rt.bgBackground, rt.p12)}
          >
            <span class={cx(rt.pgdDot3P)} data-jx-print-fx-dot="a"></span>
            <span class={cx(rt.pgdDot3P60)} data-jx-print-fx-dot="b"></span>
            <code class={cx(rt.fontMono, rt.text115)}>dual-slot fixture — jx-fx-a −0.8s/4s · jx-fx-b −2.7s/6.5s</code>
          </div>
          <div class={cx(rt.wrap12)}>
            <!-- pre-paused: never touched, never resumed -->
            <div
              data-jx-print-fx="prepaused"
              class={cx(rt.rowC8, rt.frame, rt.bgBackground, rt.px12, rt.py8)}
            >
              <span class={cx(rt.pgdDot25M)} data-jx-print-fx-dot="paused"></span>
              <code class={cx(rt.fontMono, rt.text11)}>pre-paused — currentTime 不被扰动</code>
            </div>
            ...
            <div
              ...
              class={cx(rt.rowC8, rt.frame, rt.bgBackground, rt.px12, rt.py8)}
            >
              <span class={cx(rt.pgdDot25M70)} data-jx-print-fx-dot="alt"></span>
              <code class={cx(rt.fontMono, rt.text11)}>alternate — 诊断行</code>
            </div>
            <!-- finished: c ≥ d + D·N -->
            <div
              ...
              class={cx(rt.rowC8, rt.frame, rt.bgBackground, rt.px12, rt.py8)}
            >
              <span class={cx(rt.pgdDot25B)} data-jx-print-fx-dot="fin"></span>
              <code class={cx(rt.fontMono, rt.text11)}>finished — 诊断行</code>
            </div>
            ...
            <div
              ...
              class={cx(rt.rowC8, rt.frame, rt.bgBackground, rt.px12, rt.py8)}
            >
              <code class={cx(rt.fontMono, rt.text11)}>WAAPI — 诊断行（不 throw）</code>
            </div>
          </div>
        </div>
      </SectionCard>
    ...
    <div id="verbs" data-reveal="">
      ...
      >
        ...
        <div data-jx-print-probe class={cx(rt.flex, rt.col, rt.gap6)}>
          <div class={cx(rt.rowC8, rt.overflowAuto, rt.pgdMaxBlock)} data-jx-print="hide" data-jx-print-probe-item="hide">
            <code class={cx(rt.fontMono, rt.text115)}>hide</code>
            <span class={cx(rt.text12, rt.inkMuted)}>screen 可见；分页产物中 display:none 胜过 flex</span>
          </div>
          <div class={cx(rt.rowC8, rt.overflowAuto, rt.pgdMaxBlock)} data-jx-print="flatten" data-jx-print-probe-item="flatten">
            <code class={cx(rt.fontMono, rt.text115)}>flatten</code>
            <span class={cx(rt.text12, rt.inkMuted)}>产物中 overflow:visible + max-block-size:none</span>
          </div>
          <div class={cx(rt.rowC8, rt.overflowAuto, rt.pgdMaxBlock)} data-jx-canvas-scroll data-jx-print-probe-item="canvas-scroll">
            <code class={cx(rt.fontMono, rt.text115)}>canvas-scroll</code>
            <span class={cx(rt.text12, rt.inkMuted)}>既有 hook：画布滚动层解绑（含 32rem/60vh 上限）</span>
          </div>
          <div class={cx(rt.rowC8, rt.overflowAuto, rt.pgdMaxBlock)} data-jx-code-card-pre data-jx-print-probe-item="code-card-pre">
            <code class={cx(rt.fontMono, rt.text115)}>code-card-pre</code>
            <span class={cx(rt.text12, rt.inkMuted)}>既有 hook：CodeCard 的滚动口</span>
          </div>
          <div class={cx(rt.rowC8, rt.overflowAuto, rt.pgdMaxBlock)} data-jx-props-table-scroll data-jx-print-probe-item="props-table-scroll">
            <code class={cx(rt.fontMono, rt.text115)}>props-table-scroll</code>
            <span class={cx(rt.text12, rt.inkMuted)}>markup 合同：PropsTable 包装层强制输出</span>
          </div>
        </div>
      </SectionCard>
    </div>
    ...
    <div id="gutter" data-reveal="">
      ...
      >
        <pre data-jx-print-sample class={cx(rt.overflowAuto, rt.frame, rt.bgBackground, rt.p12, rt.fontMono, rt.text115, rt.pgdLead16)}><code>{longSample}</code></pre>
        <p class={cx(rt.text13, rt.pgdLead17, rt.inkMuted)}>
    ...
    <div id="toc" data-reveal="">
      ...
      >
        <p class={cx(rt.text135, rt.pgdLead17, rt.inkMuted)}>
    ...
    <div id="determinism" data-reveal="">
      ...
      >
        <div class={cx(rt.col12, rt.text135, rt.pgdLead17, rt.inkMuted)}>
          <p>
            <strong class={cx(rt.inkFg)}>你仍然可以用</strong> 视口媒体查询（sm:/md:/lg:/max-* 与手写
            @media）和视口单位（vw/vh/vmin/vmax，含流式字号 text-[clamp(…,Nvw,…)]）——它们在 web
            面的行为不受任何影响。web 应用型项目完全可以无视本节。
          </p>
          <p>
            <strong class={cx(rt.inkFg)}>但不建议</strong> 让打印存活的内容依赖它们。管线分页发生在活窗口里：
            尽管姿势内宽度查询已被改辖域到页面内容盒、视口单位被覆写为容器单位，仍有个别形态不可表达（height
            族特征、screen 型宽度查询、被反转的怪异条件）——它们会被大声禁用并计入控制台告警，内容退回基础档。
          </p>
          <p>
            <strong class={cx(rt.inkFg)}>为什么</strong>：分页测量对窗口求值、浏览器最终渲染对纸张求值，两者错位即产物漂移——同一文档在窄窗与宽窗打印出不同的断页。验收门禁是双视口差分（800×600 ≡
            1600×1200，逐字节一致）；写作侧的最佳实践是：打印存活内容的自适应用<strong class={cx(rt.inkFg)}>容器查询</strong>（@container / cq 单位），尺寸用 rem/容器单位而非视口单位。
          </p>
        </div>
      </SectionCard>
    </div>
