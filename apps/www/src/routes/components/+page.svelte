  ...
  <div class="docs-main">
    ...
    <div id="theme-toggle" data-family="theme-toggle" data-region="theme-toggle" data-reveal="" use:reveal>
      <SectionCard
        eyebrow="registry:ui"
        title="theme-toggle"
        summary="light / dark / system cycler with Share Tech Mono labels, cycling in that order. It drives the shared theme contract (localStorage “theme”, .dark class, colorScheme) and pairs with the no-flash inline bootstrap in app.html."
      >
        <div class="flex flex-col gap-5">
          <div class="bg-terminal border border-border p-5">
            <div class="flex flex-wrap items-center gap-4">
              <span class="text-terminal-foreground/70 text-xs">rendered on its native surface:</span>
              <ThemeToggle />
            </div>
          </div>
          <p class="text-muted-foreground text-pretty text-[13px] leading-6">
            Click it — the whole site re-themes live. The toggle is the exact one sitting in the
            header of this page.
          </p>
