 ...
 *
 * Deliberately NOT shiki: the site ships short samples and the jixoai visual
 * law only needs comment/string/keyword/number tints that follow the theme
 * tokens. Output is stable across server prerender and client hydration, so
