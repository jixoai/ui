...
export const meta = defineComponentMeta(
  {
    "source": "registry/files/ui/section-card/section-card.svelte",
    "props": {
      "eyebrow": {
        "kind": "string"
      },
      ...
      "floatScope": {
        "kind": "opaque",
        "typeText": "Partial<Record<FigureKind, 'chapter' | 'document'>>"
      },
      "id": {
        "kind": "string"
      },
