...
export const meta = defineComponentMeta(
  {
    "source": "registry/files/ui/file-input/file-input.svelte",
    "props": {
      "accept": {
        "kind": "string"
      },
    ...
    "hooks": [
      "data-jx-file",
      "data-jx-file-clearrow",
      "data-jx-file-code-glyph",
      "data-jx-file-error-mark",
      "data-jx-file-icon",
      "data-jx-file-list",
      "data-jx-file-name",
      "data-jx-file-native",
      "data-jx-file-size",
      "data-jx-file-thumb",
      "data-jx-file-thumb-img",
      "data-jx-file-trigger-glyph",
      "data-jx-file-zone-hint"
    ],
    "universal": [
      {
        "axis": "size",
