...
export const meta = defineComponentMeta(
  {
    "source": "registry/files/ui/pattern-pricing/pattern-pricing.svelte",
    "props": {
      "eyebrow": {
        "kind": "string",
        "default": "$ plan --compare"
      },
      "caption": {
        "kind": "string",
        "default": "plans — feature matrix"
      },
      "tiers": {
        "kind": "opaque",
        "typeText": "readonly PricingTier[]"
      },
      "children": {
        "kind": "snippet",
        "typeText": "Snippet"
