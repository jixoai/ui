...
export const meta = defineComponentMeta(
  {
    "source": "registry/files/ui/pattern-faq/pattern-faq.svelte",
    "props": {
      "command": {
        "kind": "string",
        "default": "jixoai-ui-faq"
      },
      "section": {
        "kind": "string",
        "default": "7"
      ...
      "summary": {
        "kind": "string",
        "default": "frequently asked questions, answered in the open"
      },
      "exclusive": {
        "kind": "boolean",
        "default": true
    ...
    "hooks": [
      "data-jx-pattern-faq",
      "data-jx-pattern-faq-name",
      "data-jx-pattern-faq-see-also"
    ],
    "universal": [
      {
        "axis": "size",
