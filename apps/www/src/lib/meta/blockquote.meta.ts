...
export const meta = defineComponentMeta(
  {
    "source": "registry/files/ui/blockquote/blockquote.svelte",
    "props": {
      "variant": {
        "kind": "opaque",
        "typeText": "BlockquoteVariant",
        "ambient": "zone"
      },
      "rule": {
        "kind": "opaque",
        "typeText": "BlockquoteRule",
        "ambient": "own"
      },
      "ruleSize": {
        "kind": "opaque",
        "typeText": "BlockquoteRuleSize",
        "ambient": "own"
      },
      "density": {
        "kind": "opaque",
    ...
    "hooks": [
      "data-jx-blockquote",
      "data-jx-blockquote-cite",
      "data-jx-blockquote-label",
      "data-jx-blockquote-rule"
    ],
    "universal": [
      {
        "axis": "size",
