...
export const meta = defineComponentMeta(
  {
    "source": "registry/files/ui/math-block/math-block.svelte",
    "props": {
      "tex": {
        "kind": "string"
      },
      ...
      "labels": {
        "kind": "opaque",
        "typeText": "MathBlockLabels"
      },
      "macros": {
        "kind": "opaque",
        "typeText": "KatexOptions['macros']"
      },
      "strict": {
        "kind": "opaque",
        "typeText": "KatexOptions['strict']"
      },
      "trust": {
        "kind": "opaque",
        "typeText": "KatexOptions['trust']"
      },
      "fit": {
        "kind": "boolean",
        "default": false
