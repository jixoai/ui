...
export const meta = defineComponentMeta(
  {
    "source": "registry/files/ui/color-picker/color-picker.svelte",
    "props": {
      "value": {
        "kind": "string"
      },
      ...
      "variant": {
        "kind": "opaque",
        "typeText": "ColorPickerSurfaceVariant",
        "ambient": "own"
      },
      "showSwatch": {
        "kind": "boolean",
      ...
      "lane": {
        "kind": "snippet",
        "typeText": "Snippet<[lane: { text: string; open: boolean; disabled: boolean }]>"
      },
      "id": {
        "kind": "string"
      },
    ...
    "hooks": [
      ...
      "data-jx-color-picker-lane",
      "data-jx-color-picker-shadow",
      "data-jx-color-picker-surface",
