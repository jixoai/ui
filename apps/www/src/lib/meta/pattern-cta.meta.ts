...
export const meta = defineComponentMeta(
  {
    "source": "registry/files/ui/pattern-cta/pattern-cta.svelte",
    "props": {
      "command": {
        "kind": "string",
        "default": "npx jixoai-ui init"
      },
      "heading": {
        "kind": "string",
        "default": "ship it from your terminal"
      },
      "summary": {
        "kind": "string",
        "default": "One command pulls the theme, the tokens and every atom you name into your repo — the source stays yours."
      },
      "actionLabel": {
        "kind": "string",
