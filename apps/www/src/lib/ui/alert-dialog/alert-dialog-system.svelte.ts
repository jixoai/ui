/**
 * jixoai system dialogs (registry/files/ui/alert-dialog/
 * alert-dialog-system.svelte.ts; system-dialog, 2026-09-09 — Owner:
...
import SystemHost from './alert-dialog-system.svelte';
