<!--
  jixoai SystemDialogAction
  (registry/files/ui/system-dialog/system-dialog-action.svelte, 2026-08-25;
  ...
  data-jx-system-dialog-action={variant} stamp rides the REST LANE
...
<script lang="ts">
  ...
  const d = $derived(SystemDialogDefaults.resolve({ actionVariant: variant }));
