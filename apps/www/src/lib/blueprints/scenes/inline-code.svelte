<!-- inline-code blueprint: the code-reference chip in prose context —
     the neutral tonal default and outline rung next to explicit
     languages (tokens arrive async, SSR paints the plain chip), with
