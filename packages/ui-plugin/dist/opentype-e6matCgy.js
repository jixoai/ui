	...
	(function(global, factory) {
		...
		*/
		...
		function SVTCA(v, state) {
			if (exports$1.DEBUG) console.log(state.step, "SVTCA[" + v.axis + "]");
			state.fv = state.pv = state.dpv = v;
		}
		function SPVTCA(v, state) {
			if (exports$1.DEBUG) console.log(state.step, "SPVTCA[" + v.axis + "]");
			state.pv = state.dpv = v;
		}
		function SFVTCA(v, state) {
			if (exports$1.DEBUG) console.log(state.step, "SFVTCA[" + v.axis + "]");
			state.fv = v;
		}
		function SPVTL(a, state) {
			...
			var p2 = state.z2[p2i];
			var p1 = state.z1[p1i];
			if (exports$1.DEBUG) console.log("SPVTL[" + a + "]", p2i, p1i);
			var dx;
			var dy;
			if (!a) {
				dx = p1.x - p2.x;
		...
		function SFVTL(a, state) {
			...
			var p2 = state.z2[p2i];
			var p1 = state.z1[p1i];
			if (exports$1.DEBUG) console.log("SFVTL[" + a + "]", p2i, p1i);
			var dx;
			var dy;
			if (!a) {
				dx = p1.x - p2.x;
		...
		function SPVFS(state) {
			...
			var y = stack.pop();
			var x = stack.pop();
			if (exports$1.DEBUG) console.log(state.step, "SPVFS[]", y, x);
		...
		function GPV(state) {
			var stack = state.stack;
			var pv = state.pv;
			if (exports$1.DEBUG) console.log(state.step, "GPV[]");
		...
		function GFV(state) {
			var stack = state.stack;
			var fv = state.fv;
			if (exports$1.DEBUG) console.log(state.step, "GFV[]");
			stack.push(fv.x * 16384);
			stack.push(fv.y * 16384);
		}
		function SFVTPV(state) {
			state.fv = state.pv;
			if (exports$1.DEBUG) console.log(state.step, "SFVTPV[]");
		}
		function ISECT(state) {
			...
			var pb1 = z1[pb1i];
			var p = state.z2[pi];
			if (exports$1.DEBUG) console.log("ISECT[], ", pa0i, pa1i, pb0i, pb1i, pi);
			var x1 = pa0.x;
			var y1 = pa0.y;
			var x2 = pa1.x;
			var y2 = pa1.y;
		...
		function SRP0(state) {
			...
			if (exports$1.DEBUG) console.log(state.step, "SRP0[]", state.rp0);
		}
		function SRP1(state) {
			state.rp1 = state.stack.pop();
			if (exports$1.DEBUG) console.log(state.step, "SRP1[]", state.rp1);
		}
		function SRP2(state) {
			state.rp2 = state.stack.pop();
			if (exports$1.DEBUG) console.log(state.step, "SRP2[]", state.rp2);
		}
		function SZP0(state) {
			var n = state.stack.pop();
			if (exports$1.DEBUG) console.log(state.step, "SZP0[]", n);
			state.zp0 = n;
			switch (n) {
				case 0:
		...
		function SZP1(state) {
			var n = state.stack.pop();
			if (exports$1.DEBUG) console.log(state.step, "SZP1[]", n);
			state.zp1 = n;
			switch (n) {
				case 0:
					if (!state.tZone) initTZone(state);
		...
		function SZP2(state) {
			var n = state.stack.pop();
			if (exports$1.DEBUG) console.log(state.step, "SZP2[]", n);
			state.zp2 = n;
			switch (n) {
				case 0:
					if (!state.tZone) initTZone(state);
		...
		function SZPS(state) {
			var n = state.stack.pop();
			if (exports$1.DEBUG) console.log(state.step, "SZPS[]", n);
		...
		function SLOOP(state) {
			...
			if (exports$1.DEBUG) console.log(state.step, "SLOOP[]", state.loop);
		}
		function RTG(state) {
			if (exports$1.DEBUG) console.log(state.step, "RTG[]");
			state.round = roundToGrid;
		}
		function RTHG(state) {
			if (exports$1.DEBUG) console.log(state.step, "RTHG[]");
			state.round = roundToHalfGrid;
		}
		function SMD(state) {
			var d = state.stack.pop();
			if (exports$1.DEBUG) console.log(state.step, "SMD[]", d);
			state.minDis = d / 64;
		}
		function ELSE(state) {
			if (exports$1.DEBUG) console.log(state.step, "ELSE[]");
			skip(state, false);
		}
		function JMPR(state) {
			var o = state.stack.pop();
			if (exports$1.DEBUG) console.log(state.step, "JMPR[]", o);
			state.ip += o - 1;
		}
		function SCVTCI(state) {
			var n = state.stack.pop();
			if (exports$1.DEBUG) console.log(state.step, "SCVTCI[]", n);
			state.cvCutIn = n / 64;
		}
		function DUP(state) {
			var stack = state.stack;
			if (exports$1.DEBUG) console.log(state.step, "DUP[]");
			stack.push(stack[stack.length - 1]);
		}
		function POP(state) {
			if (exports$1.DEBUG) console.log(state.step, "POP[]");
			state.stack.pop();
		}
		function CLEAR(state) {
			if (exports$1.DEBUG) console.log(state.step, "CLEAR[]");
		...
		function SWAP(state) {
			...
			var a = stack.pop();
			var b = stack.pop();
			if (exports$1.DEBUG) console.log(state.step, "SWAP[]");
			stack.push(a);
			stack.push(b);
		}
		function DEPTH(state) {
			var stack = state.stack;
			if (exports$1.DEBUG) console.log(state.step, "DEPTH[]");
		...
		function LOOPCALL(state) {
			...
			var fn = stack.pop();
			var c = stack.pop();
			if (exports$1.DEBUG) console.log(state.step, "LOOPCALL[]", fn, c);
			var cip = state.ip;
			var cprog = state.prog;
			state.prog = state.funcs[fn];
			for (var i = 0; i < c; i++) {
				exec(state);
				if (exports$1.DEBUG) console.log(++state.step, i + 1 < c ? "next loopcall" : "done loopcall", i);
			}
			state.ip = cip;
			state.prog = cprog;
		}
		function CALL(state) {
			...
			if (exports$1.DEBUG) console.log(state.step, "CALL[]", fn);
			var cip = state.ip;
			var cprog = state.prog;
			state.prog = state.funcs[fn];
			exec(state);
			state.ip = cip;
			state.prog = cprog;
			if (exports$1.DEBUG) console.log(++state.step, "returning from", fn);
		}
		function CINDEX(state) {
			var stack = state.stack;
			var k = stack.pop();
			if (exports$1.DEBUG) console.log(state.step, "CINDEX[]", k);
			stack.push(stack[stack.length - k]);
		}
		function MINDEX(state) {
			var stack = state.stack;
			var k = stack.pop();
			if (exports$1.DEBUG) console.log(state.step, "MINDEX[]", k);
		...
		function FDEF(state) {
			...
			var fn = stack.pop();
			var ipBegin = ip;
			if (exports$1.DEBUG) console.log(state.step, "FDEF[]", fn);
			while (prog[++ip] !== 45);
			state.ip = ip;
		...
		function MDAP(round, state) {
			...
			var fv = state.fv;
			var pv = state.pv;
			if (exports$1.DEBUG) console.log(state.step, "MDAP[" + round + "]", pi);
		...
		function IUP(v, state) {
			...
			var pp;
			var np;
			if (exports$1.DEBUG) console.log(state.step, "IUP[" + v.axis + "]");
			for (var i = 0; i < pLen; i++) {
				cp = z2[i];
		...
		function SHP(a, state) {
			...
			while (loop--) {
				...
				fv.touch(p);
				if (exports$1.DEBUG) console.log(state.step, (state.loop > 1 ? "loop " + (state.loop - loop) + ": " : "") + "SHP[" + (a ? "rp1" : "rp2") + "]", pi);
			}
			state.loop = 1;
		}
		function SHC(a, state) {
			...
			var p = sp;
			if (exports$1.DEBUG) console.log(state.step, "SHC[" + a + "]", ci);
			var d = pv.distance(rp, rp, false, true);
			do {
		...
		function SHZ(a, state) {
			...
			var pv = state.pv;
			var e = stack.pop();
			if (exports$1.DEBUG) console.log(state.step, "SHZ[" + a + "]", e);
			var z;
			switch (e) {
				case 0:
					z = state.tZone;
		...
		function SHPIX(state) {
			...
			while (loop--) {
				var pi = stack.pop();
				var p = z2[pi];
				if (exports$1.DEBUG) console.log(state.step, (state.loop > 1 ? "loop " + (state.loop - loop) + ": " : "") + "SHPIX[]", pi, d);
		...
		function IP(state) {
			...
			while (loop--) {
				var pi = stack.pop();
				var p = z2[pi];
				if (exports$1.DEBUG) console.log(state.step, (state.loop > 1 ? "loop " + (state.loop - loop) + ": " : "") + "IP[]", pi, rp1i, "<->", rp2i);
		...
		function MSIRP(a, state) {
			...
			fv.touch(p);
			if (exports$1.DEBUG) console.log(state.step, "MSIRP[" + a + "]", d, pi);
			state.rp1 = state.rp0;
			state.rp2 = pi;
			if (a) state.rp0 = pi;
		}
		function ALIGNRP(state) {
			...
			while (loop--) {
				var pi = stack.pop();
				var p = z1[pi];
				if (exports$1.DEBUG) console.log(state.step, (state.loop > 1 ? "loop " + (state.loop - loop) + ": " : "") + "ALIGNRP[]", pi);
		...
		function RTDG(state) {
			if (exports$1.DEBUG) console.log(state.step, "RTDG[]");
		...
		function MIAP(round, state) {
			...
			var pv = state.pv;
			var cv = state.cvt[n];
			if (exports$1.DEBUG) console.log(state.step, "MIAP[" + round + "]", n, "(", cv, ")", pi);
			var d = pv.distance(p, HPZero);
			if (round) {
		...
		function NPUSHB(state) {
			...
			var stack = state.stack;
			var n = prog[++ip];
			if (exports$1.DEBUG) console.log(state.step, "NPUSHB[]", n);
		...
		function NPUSHW(state) {
			...
			var stack = state.stack;
			var n = prog[++ip];
			if (exports$1.DEBUG) console.log(state.step, "NPUSHW[]", n);
			for (var i = 0; i < n; i++) {
		...
		function WS(state) {
			...
			var v = stack.pop();
			var l = stack.pop();
			if (exports$1.DEBUG) console.log(state.step, "WS", v, l);
			store[l] = v;
		}
		function RS(state) {
			var stack = state.stack;
			var store = state.store;
			var l = stack.pop();
			if (exports$1.DEBUG) console.log(state.step, "RS", l);
		...
		function WCVTP(state) {
			...
			var v = stack.pop();
			var l = stack.pop();
			if (exports$1.DEBUG) console.log(state.step, "WCVTP", v, l);
			state.cvt[l] = v / 64;
		}
		function RCVT(state) {
			var stack = state.stack;
			var cvte = stack.pop();
			if (exports$1.DEBUG) console.log(state.step, "RCVT", cvte);
		...
		function GC(a, state) {
			...
			var pi = stack.pop();
			var p = state.z2[pi];
			if (exports$1.DEBUG) console.log(state.step, "GC[" + a + "]", pi);
		...
		function MD(a, state) {
			...
			if (exports$1.DEBUG) console.log(state.step, "MD[" + a + "]", pi2, pi1, "->", d);
			state.stack.push(Math.round(d * 64));
		}
		function MPPEM(state) {
			if (exports$1.DEBUG) console.log(state.step, "MPPEM[]");
			state.stack.push(state.ppem);
		}
		function FLIPON(state) {
			if (exports$1.DEBUG) console.log(state.step, "FLIPON[]");
			state.autoFlip = true;
		}
		function LT(state) {
			var stack = state.stack;
			var e2 = stack.pop();
			var e1 = stack.pop();
			if (exports$1.DEBUG) console.log(state.step, "LT[]", e2, e1);
		...
		function LTEQ(state) {
			...
			var e2 = stack.pop();
			var e1 = stack.pop();
			if (exports$1.DEBUG) console.log(state.step, "LTEQ[]", e2, e1);
			stack.push(e1 <= e2 ? 1 : 0);
		}
		function GT(state) {
			var stack = state.stack;
			var e2 = stack.pop();
			var e1 = stack.pop();
			if (exports$1.DEBUG) console.log(state.step, "GT[]", e2, e1);
			stack.push(e1 > e2 ? 1 : 0);
		}
		function GTEQ(state) {
			var stack = state.stack;
			var e2 = stack.pop();
			var e1 = stack.pop();
			if (exports$1.DEBUG) console.log(state.step, "GTEQ[]", e2, e1);
			stack.push(e1 >= e2 ? 1 : 0);
		}
		function EQ(state) {
			var stack = state.stack;
			var e2 = stack.pop();
			var e1 = stack.pop();
			if (exports$1.DEBUG) console.log(state.step, "EQ[]", e2, e1);
		...
		function NEQ(state) {
			...
			var e2 = stack.pop();
			var e1 = stack.pop();
			if (exports$1.DEBUG) console.log(state.step, "NEQ[]", e2, e1);
			stack.push(e2 !== e1 ? 1 : 0);
		}
		function ODD(state) {
			var stack = state.stack;
			var n = stack.pop();
			if (exports$1.DEBUG) console.log(state.step, "ODD[]", n);
			stack.push(Math.trunc(n) % 2 ? 1 : 0);
		}
		function EVEN(state) {
			var stack = state.stack;
			var n = stack.pop();
			if (exports$1.DEBUG) console.log(state.step, "EVEN[]", n);
			stack.push(Math.trunc(n) % 2 ? 0 : 1);
		}
		function IF(state) {
			var test = state.stack.pop();
			if (exports$1.DEBUG) console.log(state.step, "IF[]", test);
			if (!test) {
				skip(state, true);
				if (exports$1.DEBUG) console.log(state.step, "EIF[]");
			}
		}
		function EIF(state) {
			if (exports$1.DEBUG) console.log(state.step, "EIF[]");
		...
		function AND(state) {
			...
			var e2 = stack.pop();
			var e1 = stack.pop();
			if (exports$1.DEBUG) console.log(state.step, "AND[]", e2, e1);
			stack.push(e2 && e1 ? 1 : 0);
		}
		function OR(state) {
			var stack = state.stack;
			var e2 = stack.pop();
			var e1 = stack.pop();
			if (exports$1.DEBUG) console.log(state.step, "OR[]", e2, e1);
			stack.push(e2 || e1 ? 1 : 0);
		}
		function NOT(state) {
			var stack = state.stack;
			var e = stack.pop();
			if (exports$1.DEBUG) console.log(state.step, "NOT[]", e);
			stack.push(e ? 0 : 1);
		}
		function DELTAP123(b, state) {
			...
			var z0 = state.z0;
			if (exports$1.DEBUG) console.log(state.step, "DELTAP[" + b + "]", n, stack);
			for (var i = 0; i < n; i++) {
				var pi = stack.pop();
				var arg = stack.pop();
				...
				var mag = (arg & 15) - 8;
				if (mag >= 0) mag++;
				if (exports$1.DEBUG) console.log(state.step, "DELTAPFIX", pi, "by", mag * ds);
				var p = z0[pi];
		...
		function SDB(state) {
			var n = state.stack.pop();
			if (exports$1.DEBUG) console.log(state.step, "SDB[]", n);
			state.deltaBase = n;
		}
		function SDS(state) {
			var n = state.stack.pop();
			if (exports$1.DEBUG) console.log(state.step, "SDS[]", n);
		...
		function ADD(state) {
			...
			var n2 = stack.pop();
			var n1 = stack.pop();
			if (exports$1.DEBUG) console.log(state.step, "ADD[]", n2, n1);
			stack.push(n1 + n2);
		}
		function SUB(state) {
			var stack = state.stack;
			var n2 = stack.pop();
			var n1 = stack.pop();
			if (exports$1.DEBUG) console.log(state.step, "SUB[]", n2, n1);
			stack.push(n1 - n2);
		}
		function DIV(state) {
			var stack = state.stack;
			var n2 = stack.pop();
			var n1 = stack.pop();
			if (exports$1.DEBUG) console.log(state.step, "DIV[]", n2, n1);
			stack.push(n1 * 64 / n2);
		}
		function MUL(state) {
			var stack = state.stack;
			var n2 = stack.pop();
			var n1 = stack.pop();
			if (exports$1.DEBUG) console.log(state.step, "MUL[]", n2, n1);
			stack.push(n1 * n2 / 64);
		}
		function ABS(state) {
			var stack = state.stack;
			var n = stack.pop();
			if (exports$1.DEBUG) console.log(state.step, "ABS[]", n);
			stack.push(Math.abs(n));
		}
		function NEG(state) {
			var stack = state.stack;
			var n = stack.pop();
			if (exports$1.DEBUG) console.log(state.step, "NEG[]", n);
			stack.push(-n);
		}
		function FLOOR(state) {
			var stack = state.stack;
			var n = stack.pop();
			if (exports$1.DEBUG) console.log(state.step, "FLOOR[]", n);
			stack.push(Math.floor(n / 64) * 64);
		}
		function CEILING(state) {
			var stack = state.stack;
			var n = stack.pop();
			if (exports$1.DEBUG) console.log(state.step, "CEILING[]", n);
			stack.push(Math.ceil(n / 64) * 64);
		}
		function ROUND(dt, state) {
			var stack = state.stack;
			var n = stack.pop();
			if (exports$1.DEBUG) console.log(state.step, "ROUND[]");
		...
		function WCVTF(state) {
			...
			var v = stack.pop();
			var l = stack.pop();
			if (exports$1.DEBUG) console.log(state.step, "WCVTF[]", v, l);
		...
		function DELTAC123(b, state) {
			...
			var base = state.deltaBase + (b - 1) * 16;
			var ds = state.deltaShift;
			if (exports$1.DEBUG) console.log(state.step, "DELTAC[" + b + "]", n, stack);
			for (var i = 0; i < n; i++) {
				var c = stack.pop();
				var arg = stack.pop();
				if (base + ((arg & 240) >> 4) !== ppem) continue;
				...
				if (mag >= 0) mag++;
				var delta = mag * ds;
				if (exports$1.DEBUG) console.log(state.step, "DELTACFIX", c, "by", delta);
				state.cvt[c] += delta;
			}
		}
		function SROUND(state) {
			var n = state.stack.pop();
			if (exports$1.DEBUG) console.log(state.step, "SROUND[]", n);
		...
		function S45ROUND(state) {
			var n = state.stack.pop();
			if (exports$1.DEBUG) console.log(state.step, "S45ROUND[]", n);
			state.round = roundSuper;
			var period;
			switch (n & 192) {
				case 0:
		...
		function ROFF(state) {
			if (exports$1.DEBUG) console.log(state.step, "ROFF[]");
			state.round = roundOff;
		}
		function RUTG(state) {
			if (exports$1.DEBUG) console.log(state.step, "RUTG[]");
			state.round = roundUpToGrid;
		}
		function RDTG(state) {
			if (exports$1.DEBUG) console.log(state.step, "RDTG[]");
			state.round = roundDownToGrid;
		}
		function SCANCTRL(state) {
			var n = state.stack.pop();
			if (exports$1.DEBUG) console.log(state.step, "SCANCTRL[]", n);
		}
		function SDPVTL(a, state) {
			...
			var p2 = state.z2[p2i];
			var p1 = state.z1[p1i];
			if (exports$1.DEBUG) console.log(state.step, "SDPVTL[" + a + "]", p2i, p1i);
			var dx;
			var dy;
			if (!a) {
				dx = p1.x - p2.x;
		...
		function GETINFO(state) {
			...
			var sel = stack.pop();
			var r = 0;
			if (exports$1.DEBUG) console.log(state.step, "GETINFO[]", sel);
			if (sel & 1) r = 35;
			if (sel & 32) r |= 4096;
			stack.push(r);
		}
		function ROLL(state) {
			...
			var b = stack.pop();
			var c = stack.pop();
			if (exports$1.DEBUG) console.log(state.step, "ROLL[]");
			stack.push(b);
			stack.push(a);
			stack.push(c);
		}
		function MAX(state) {
			...
			var e2 = stack.pop();
			var e1 = stack.pop();
			if (exports$1.DEBUG) console.log(state.step, "MAX[]", e2, e1);
		...
		function MIN(state) {
			...
			var e2 = stack.pop();
			var e1 = stack.pop();
			if (exports$1.DEBUG) console.log(state.step, "MIN[]", e2, e1);
			stack.push(Math.min(e1, e2));
		}
		function SCANTYPE(state) {
			var n = state.stack.pop();
			if (exports$1.DEBUG) console.log(state.step, "SCANTYPE[]", n);
		}
		function INSTCTRL(state) {
			var s = state.stack.pop();
			var v = state.stack.pop();
			if (exports$1.DEBUG) console.log(state.step, "INSTCTRL[]", s, v);
			switch (s) {
				case 1:
		...
		function PUSHB(n, state) {
			...
			var prog = state.prog;
			var ip = state.ip;
			if (exports$1.DEBUG) console.log(state.step, "PUSHB[" + n + "]");
			for (var i = 0; i < n; i++) stack.push(prog[++ip]);
			state.ip = ip;
		}
		function PUSHW(n, state) {
			...
			var prog = state.prog;
			var stack = state.stack;
			if (exports$1.DEBUG) console.log(state.ip, "PUSHW[" + n + "]");
			for (var i = 0; i < n; i++) {
				var w = prog[++ip] << 8 | prog[++ip];
				if (w & 32768) w = -((w ^ 65535) + 1);
				stack.push(w);
		...
		function MDRP_MIRP(indirect, setRp0, keepD, ro, dt, state) {
			...
			fv.touch(p);
			if (exports$1.DEBUG) console.log(state.step, (indirect ? "MIRP[" : "MDRP[") + (setRp0 ? "M" : "m") + (keepD ? ">" : "_") + (ro ? "R" : "_") + (dt === 0 ? "Gr" : dt === 1 ? "Bl" : dt === 2 ? "Wh" : "") + "]", indirect ? cvte + "(" + state.cvt[cvte] + "," + cv + ")" : "", pi, "(d =", od, "->", sign * d, ")");
			state.rp1 = state.rp0;
			state.rp2 = pi;
		...
		*/
		function loadSync(url, opt) {
			return parseBuffer(nodeBufferToArrayBuffer(__require("fs").readFileSync(url)), opt);
		}
		...
		exports$1.Font = Font;
		exports$1.Glyph = Glyph;
		exports$1.Path = Path;
		exports$1._parse = parse;
		exports$1.default = opentype;
		exports$1.load = load;
		exports$1.loadSync = loadSync;
		exports$1.parse = parseBuffer;
...
//# sourceMappingURL=opentype-e6matCgy.js.map