...
//
// Intents:
//   1. dist/index.js + dist/probe.js as clean ESM outputs (node platform;
//      vite stays external as a peer dependency — the package has zero
//      runtime dependencies by law).
//   2. dist/index.d.ts via dts generation; dist/client.d.ts is copied
