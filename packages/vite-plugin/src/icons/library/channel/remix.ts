/**
 * @jixoai/ui-vite-plugin (icons library channels) — the remix channel
 * factory (A2, openspec icon-channel-api design §1; the
 ...
 * pipeline in resolve.ts. This module doubles as the `…/icons/rx`
...
/**
 * build the remix channel — `import { rx } from
 * '@jixoai/ui-vite-plugin/icons/rx'` then `channels: [rx()]` (no
 * config knobs: the category rides the name).
 */
export function rx(): IconChannel {
