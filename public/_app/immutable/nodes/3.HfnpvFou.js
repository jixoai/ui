import{$ as e,A as t,B as n,C as r,D as i,G as a,H as o,I as s,J as c,K as l,M as u,N as d,O as f,P as p,T as m,V as h,W as g,X as _,Y as v,Z as y,_ as b,a as x,at as S,b as C,c as w,d as T,et as ee,g as E,h as D,it as O,m as k,n as A,q as j,tt as M}from"../chunks/BRzkkxAc.js";import"../chunks/xihTtKlq.js";import{t as N}from"../chunks/DH0BeFh4.js";import{n as te,r as ne,t as P}from"../chunks/DRAvfdr1.js";import{i as F,n as I,r as L,t as R}from"../chunks/BL2m-LPG.js";function z(e,t={}){let n=t.lineOffset??1,r=(typeof t.scrollRoot==`string`?document.querySelector(t.scrollRoot):t.scrollRoot??null)??window,i=Array.from(document.querySelectorAll(`[data-region]`)),a=Array.from(document.querySelectorAll(`[data-family]`)),o=0,s=``,c=(e,t,n)=>{let r=Math.max(0,Math.min(e.right,t)-Math.max(e.left,0)),i=Math.max(0,Math.min(e.bottom,n)-Math.max(e.top,0));if(r<=0||i<=0)return 0;let a=r*i,o=Math.min(e.width*e.height,t*n);return o>0?Math.min(1,a/o):0},l=()=>{o=0;let t=innerWidth,r=innerHeight,l=typeof n==`function`?n():n,u=new Map,d=new Map;for(let e of a){let n=c(e.getBoundingClientRect(),t,r);n>0&&d.set(e.dataset.family,n)}for(let e of i){let n=c(e.getBoundingClientRect(),t,r);n>0&&u.set(e.dataset.region,n)}let f=i.length>0?i[i.length-1].dataset.region:null;for(let e of i)if(e.getBoundingClientRect().bottom>l){f=e.dataset.region;break}let p=f+`|`+[...u.entries()].map(([e,t])=>e+t.toFixed(2)).sort().join(`,`);p!==s&&(s=p,e({weights:u,pick:f,familyWeights:d}))},u=()=>{o||=requestAnimationFrame(l)};return r.addEventListener(`scroll`,u,{passive:!0}),addEventListener(`resize`,u,{passive:!0}),l(),()=>{r.removeEventListener(`scroll`,u),removeEventListener(`resize`,u),o&&cancelAnimationFrame(o)}}var B=t(`<li><a> </a></li>`),re=t(`<li><a><span class="jx-cursor" aria-hidden="true">❯</span> <span> </span></a></li>`),V=t(`<div class="jx-toc"><nav class="jx-toc-desktop" aria-label="Table of contents"><span class="jx-spine"><span class="jx-spine-fill"></span></span> <p class="jx-toc-title"> </p> <ol></ol></nav> <div class="jx-toc-mobile jx-glass"><div class="jx-viewport"><ol></ol></div> <button type="button" class="jx-toggle" aria-label="Expand table of contents">▾</button></div></div>`);function H(e,t){M(t,!0);let n=x(t,`title`,3,`reading progress`),l=x(t,`scrollRoot`,3,null),u=y(()=>t.sections.flatMap((e,t)=>[{id:e.id,label:e.label,level:1,index:t+1},...(e.children??[]).map(e=>({id:e.id,label:e.label,level:2,index:t+1}))])),d=y(()=>s(u).map(e=>e.id)),m=y(()=>new Map(t.sections.flatMap(e=>(e.children??[]).map(t=>[t.id,e.id])))),g=c([]),b=c([]),C=_(null),E=_(null),O=_(null),A=_(!1),N=_(null),te=()=>{let e=innerWidth<900,t=(e?s(E):document.querySelector(`.jx-scaffold-header`))?.getBoundingClientRect(),n=t?Math.round(t.bottom)+32:e?76:106;return document.documentElement.style.setProperty(`--jx-toc-line`,`${n}px`),n};o(()=>{te();let e=z(({weights:e,pick:t})=>{for(let t of g)t.style.setProperty(`--w`,(e.get(t.dataset.id)??0).toFixed(3));for(let t of b)t.style.setProperty(`--w`,(e.get(t.dataset.id)??0).toFixed(3));if(!t)return;v(N,t,!0);let n=s(m).get(t);for(let e of g){let r=e.dataset.id===t||e.dataset.id===n;e.classList.toggle(`active`,r)}for(let e of b){let n=e.dataset.id===t;e.style.setProperty(`--jx-cur`,n?`1`:`0`),n?e.setAttribute(`aria-current`,`true`):e.removeAttribute(`aria-current`)}let r=b.find(e=>e.dataset.id===t)?.closest(`li`);s(E)&&r&&s(E).scrollTo({top:r.offsetTop})},{lineOffset:te,scrollRoot:l()}),t=typeof l()==`string`?document.querySelector(l()):l(),n=()=>{if(!s(C))return;let e=t?t.scrollHeight-t.clientHeight:document.documentElement.scrollHeight-innerHeight,n=t?t.scrollTop:scrollY,r=e>0?Math.min(1,Math.max(0,n/e)):0;s(C).style.setProperty(`--jx-progress`,Math.max(.02,r).toFixed(3))};return(t??window).addEventListener(`scroll`,n,{passive:!0}),n(),()=>{e(),(t??window).removeEventListener(`scroll`,n)}});let ne=()=>{let e=b.find(e=>e.dataset.id===s(N))?.closest(`li`);s(E)&&e&&s(E).scrollTo({top:e.offsetTop})},P=()=>{v(A,!1),s(E)?.addEventListener(`transitionend`,e=>{e.propertyName===`height`&&ne()},{once:!0})};var F=V(),I=a(F),L=a(I),R=a(L);w(R,e=>v(C,e),()=>s(C)),S(L);var H=j(L,2),U=a(H,!0);S(H);var W=j(H,2);r(W,21,()=>s(u),e=>e.id,(e,t)=>{var n=B(),r=a(n),o=a(r,!0);S(r),S(n),w(n,(e,t)=>g[s(d).indexOf(t.id)]=e,e=>g?.[s(d).indexOf(e.id)],()=>[s(t)]),h(()=>{k(n,1,D(s(t).level===2?`lvl-2`:``)),T(n,`data-id`,s(t).id),T(r,`href`,`#${s(t).id}`),i(o,s(t).label)}),f(e,n)}),S(W),S(I);var G=j(I,2),K=a(G),ie=a(K);r(ie,21,()=>s(u),e=>e.id,(e,t)=>{var n=re(),r=a(n),o=j(a(r),2),c=a(o,!0);S(o),S(r),w(r,(e,t)=>b[s(d).indexOf(t.id)]=e,e=>b?.[s(d).indexOf(e.id)],()=>[s(t)]),S(n),h(()=>{k(r,1,D(s(t).level===2?`lvl-2`:``)),T(r,`href`,`#${s(t).id}`),T(r,`data-id`,s(t).id),i(c,s(t).label)}),p(`click`,r,P),f(e,n)}),S(ie),S(K),w(K,e=>v(E,e),()=>s(E));var ae=j(K,2);S(G),w(G,e=>v(O,e),()=>s(O)),S(F),h(()=>{i(U,n()),T(G,`data-open`,s(A)||void 0),T(ae,`aria-expanded`,s(A))}),p(`click`,ae,()=>s(A)?P():v(A,!0)),f(e,F),ee()}d([`click`]);var U=t(`<div class="jx-float-anchor" aria-hidden="true"></div> <div class="jx-float-content"><!></div>`,1);function W(t,n){M(n,!0);let r=e(`jx-scaffold-float`),i=_(null),o=_(null);A(()=>{if(!s(i))return;let e=r.set(s(i));return()=>{e(),s(o)?.appendChild(s(i))}});var c=U(),u=l(c);w(u,e=>v(o,e),()=>s(o));var d=j(u,2),p=a(d);C(p,()=>n.children),S(d),w(d,e=>v(i,e),()=>s(i)),f(t,c),ee()}var G=t(`<meta name="description" content="The jixoai component gallery: press-button, section-card, theme-toggle, reveal, the Combo ToC, the typing terminal, the hero, the app shell, and the terminal chrome — every demo rendered from the registry files this site consumes."/>`),K=t(`<aside class="docs-aside svelte-9maxek" aria-label="On this page"><!></aside>`),ie=t(`<div class="flex flex-wrap gap-3"><span class="pill">9 live components</span> <span class="pill">2 framework-free libs</span> <span class="pill">1 dogfooded ToC</span> <span class="pill">zero network</span></div>`),ae=t(`<div class="flex flex-col gap-7" data-region="press-variants"><div id="press-variants" class="flex flex-col gap-3"><h3 class="text-[15px] font-bold tracking-tight">Variants, one physics</h3> <div class="flex flex-wrap items-center gap-3"><!> <!> <!></div> <p class="text-muted-foreground text-pretty text-[13px] leading-6">The third button is the copied feedback state — click it: the command is copied and
...
/>`;var D=ge();b(`9maxek`,e=>{var t=G();n(()=>{g.title=`Components · jixoai/ui`}),f(e,t)});var k=l(D);W(k,{children:(e,n)=>{var r=K();H(a(r),{get sections(){return t},title:`on this page`,scrollRoot:`.jx-shell-body`}),S(r),f(e,r)},$$slots:{default:!0}});var A=j(k,2),M=a(A),z=a(M),B=a(z),re=a(B);R(re,{headingLevel:1,tone:`hero`,eyebrow:`Gallery`,title:`Every component, rendered from the registry`,summary:`Each section below consumes the exact same-source copy this site installed from registry/files — nothing is reimplemented for the showcase. The table of contents tracking this page is itself the toc component: the Rule Tracker on the right (desktop) or the glass Terminal Rail above (mobile).`,children:(e,t)=>{var n=ie();f(e,n)},$$slots:{default:!0}}),S(B),E(B,e=>I?.(e)),S(z);var V=j(z,2),U=a(V);R(U,{headerRegion:`press-button`,eyebrow:`registry:ui`,title:`press-button`,summary:`The brutalist press-physics button: hover lifts toward the viewer (shadow xs grows), active presses back into the page. The shadow is the affordance — there is no other button style in the grammar.`,children:(e,t)=>{var n=ae(),r=a(n),i=j(a(r),2),o=a(i);L(o,{variant:`primary`,children:(e,t)=>{O();var n=u(`primary`);f(e,n)},$$slots:{default:!0}});var s=j(o,2);L(s,{variant:`outline`,children:(e,t)=>{O();var n=u(`outline`);f(e,n)},$$slots:{default:!0}});var c=j(s,2);ne(c,{command:`npx jixoai-ui add press-button`,label:`copied (press me)`}),S(i),O(2),S(r);var l=j(r,2);F(l,{code:y,lang:`svelte`,meta:`usage`}),S(n),f(e,n)},$$slots:{default:!0}}),S(V),E(V,e=>I?.(e));var q=j(V,2),_e=a(q);R(_e,{headerRegion:`section-card`,eyebrow:`registry:ui`,title:`section-card`,summary:`The content atom of the site grammar: a bordered card, header block with eyebrow (brand hue, Share Tech Mono, tracked 0.24em), font-nav title, text-pretty summary, and a body snippet slot.`,children:(e,t)=>{var n=se(),r=a(n),i=j(a(r),4);R(i,{eyebrow:`inner`,title:`A card, nested`,children:(e,t)=>{var n=oe();f(e,n)},$$slots:{default:!0}}),S(r);var o=j(r,2);F(o,{get code(){return x},lang:`svelte`,meta:`usage`}),S(n),f(e,n)},$$slots:{default:!0}}),S(q),E(q,e=>I?.(e));var J=j(q,2),ve=a(J);R(ve,{headerRegion:`theme-toggle`,eyebrow:`registry:ui`,title:`theme-toggle`,summary:`light / dark / system in four variants: full (segmented icon+label selector — click a mode to set it), compact (icon + current, cycles), icon (icon only, cycles), text (label only, cycles). Inline SVG icons, no icon-library dependency; drives the shared theme contract (localStorage “theme”, .dark class, colorScheme) with the no-flash bootstrap.`,children:(e,t)=>{var n=ce(),r=a(n),i=a(r),o=j(a(i));N(o,{variant:`full`}),S(i);var s=j(i,2),c=j(a(s));N(c,{variant:`compact`}),S(s);var l=j(s,2),u=j(a(l));N(u,{variant:`icon`}),S(l);var d=j(l,2),p=j(a(d));N(p,{variant:`text`}),S(d),S(r);var m=j(r,4);F(m,{code:C,lang:`svelte`,meta:`usage`}),S(n),f(e,n)},$$slots:{default:!0}}),S(J),E(J,e=>I?.(e));var Y=j(J,2),ye=a(Y);R(ye,{headerRegion:`reveal`,eyebrow:`registry:lib`,title:`reveal`,summary:`The scroll-reveal action. Motion is restrained to exactly two patterns: entrance (opacity + rise, or a rule that draws in) and press physics. Every animated element on this site uses one of them.`,children:(e,t)=>{var n=ue(),o=a(n),s=j(a(o),4);r(s,20,()=>[0,1,2],e=>e,(e,t)=>{var n=le(),r=a(n),o=a(r);S(r),O(2),S(n),E(n,(e,t)=>I?.(e,t),()=>({delay:t*90,rise:12})),h(()=>i(o,`block ${t+1}`)),f(e,n)}),S(s);var c=j(s,2);E(c,e=>I?.(e)),O(2),S(o);var l=j(o,2);F(l,{code:w,lang:`svelte`,meta:`usage`}),S(n),f(e,n)},$$slots:{default:!0}}),S(Y),E(Y,e=>I?.(e));var X=j(Y,2),be=a(X);R(be,{headerRegion:`toc`,eyebrow:`registry:ui`,title:`toc — the Combo ToC`,summary:`You are looking at it. Desktop gets the Rule Tracker: a scroll-progress spine, square weight-driven nodes on level-1 entries, and the pick + parent markers. Mobile gets the Terminal Rail: a glass single-row viewport where page scroll drives the row to the current entry, and expanding changes ONLY the height.`,children:(e,t)=>{var n=de(),r=a(n),i=j(a(r),4);F(i,{get code(){return T},lang:`svelte`,meta:`contract`}),S(r),S(n),f(e,n)},$$slots:{default:!0}}),S(X),E(X,e=>I?.(e));var Z=j(X,2),xe=a(Z);R(xe,{headerRegion:`terminal-card`,eyebrow:`registry:ui`,title:`terminal-card`,summary:`The Broadside hero terminal, composed after the openspecui reference: traffic-light title bar, one large typed command, outputs surfacing line by line, 6px hard offset shadow. One-shot typing entrance (never looping), static block cursor per the motion law; prerendered/no-JS shows the settled terminal and reduced motion renders instantly.`,children:(e,t)=>{var n=fe(),r=a(n),i=j(a(r),4),c=a(i);m(c,()=>s(o),e=>{P(e,{barTitle:`quick-start — zsh`,command:`npx jixoai-ui add terminal-card`,outputs:[`terminal-card.svelte → src/lib/ui/`,`one-shot typing · static cursor · no blink`]})}),S(i);var l=j(i,2),d=a(l);L(d,{onclick:()=>v(o,s(o)+1),children:(e,t)=>{O();var n=u(`Replay ↻`);f(e,n)},$$slots:{default:!0}}),S(l),S(r),S(n),f(e,n)},$$slots:{default:!0}}),S(Z),E(Z,e=>I?.(e));var Q=j(Z,2),Se=a(Q);R(Se,{headerRegion:`hero-section`,eyebrow:`registry:ui`,title:`hero-section`,summary:`The Broadside hero, composed after the openspecui reference: clamp-scaled bold lead type with a primary accent tail, badge row, a copy-command PRIMARY CTA with copied feedback, and the terminal card in a bottom-aligned second column at min-1100px. The homepage is the full-bleed demo; this is the component rendered in place.`,children:(e,t)=>{var n=pe(),r=a(n),i=j(a(r),2),o=a(i);te(o,{eyebrow:`your-app · v0`,titleLead:`Your product line here. `,titleAccent:`Your accent.`,summary:`A compact instance with the real composition rules — swap the copy, keep the law.`,badges:[`badges`,`copy CTA`,`terminal demo`],copyCommand:`npx jixoai-ui init --hue 210`,terminal:e=>{P(e,{barTitle:`demo`,command:`echo hello jixoai`,outputs:[`→ composed from the registry files`]})},$$slots:{terminal:!0}}),S(i);var s=j(i,2);F(s,{code:d,lang:`svelte`,meta:`usage`}),S(r),S(n),f(e,n)},$$slots:{default:!0}}),S(Q),E(Q,e=>I?.(e));var $=j(Q,2),Ce=a($);R(Ce,{headerRegion:`app-shell`,eyebrow:`registry:ui`,title:`app-shell`,summary:`The page scaffold: a sticky, always-visible header band (this page's navigation never scrolls away), the main column, an optional footer band, and a skip link. It also ships the systematized MPA view transitions — cross-document navigation with a persistent site-header and a horizontal-slide + blur crossfade on page-main (navigate this site in Chrome/Edge to feel it; reduced motion crossfades).`,children:(e,t)=>{var n=me(),r=a(n),i=j(a(r),4);F(i,{code:p,lang:`svelte`,meta:`usage`}),S(r),S(n),f(e,n)},$$slots:{default:!0}}),S($),E($,e=>I?.(e));var we=j($,2),Te=a(we);R(Te,{headerRegion:`shell`,eyebrow:`registry:ui`,title:`terminal-header / terminal-footer`,summary:`The site shell. The header is an always-dark CRT bezel (never a themed surface) with the brand eyebrow in brand hue, nav pills, and the theme slot at the far right; the footer is a giant ghost wordmark that closes the narrative. This page does not render a second pair — you're wearing one — so here is how they attach instead.`,children:(e,t)=>{var n=he(),r=a(n),i=j(a(r),4);F(i,{code:ee,lang:`svelte`,meta:`shell`}),S(r),S(n),f(e,n)},$$slots:{default:!0}}),S(we),E(we,e=>I?.(e)),S(M),S(A),f(e,D)}export{q as component};