# Tasks — the tailwindless one-shot

## W1 — component families (52 top families, ~4,500 occurrences)

- [x] 1.1 Four parallel batch agents (0/1/2/3) migrate their disjoint
  family sets onto stylex atoms + lane-2 css; mirrors cmp-identical
- [x] 1.2 Serial integration: cx law ruling (component-local, zero
  exceptions — research/wave1-integration.md §Ruling 1)
- [x] 1.3 Serial integration: the Wave-1 scale extension (30 sheet
  steps + 31 typed members; declines recorded — §Ruling 2)
- [x] 1.4 Serial integration: registry.json (+99 file entries, +46
  dependency edges) + migration ledger (+53 modules — §Ruling 3)
- [x] 1.5 cx unification agent lands (24 modules / 61 import sites →
  component-local; STYLEX_MODULE_HELPERS empties; batteries green)
- [x] 1.6 css canonicalization agent lands (31 sheets ×2 mirrors:
  canonical tier-0 statement at byte zero + exact-value literal →
  token swaps; ledger += 31 css)
