...
- [x] 1. **P0 contract** — change docs ACCEPTED (Codex round), packet
...
- [x] 2. **P5a probe scaffolding** — BOTH verify scripts committed
  ...
  *Gate: scripts execute on repo Chromium; failures are assertion-red,
  not crash.*
- [x] 3. **P2 theme pair** — appendix A verbatim in the canonical sheet
...
- [x] 4. **P3 context module** — registry:lib item files both trees +
...
- [x] 5. **P4 list-item migration (ONE packet, both halves)** — size→
...
- [x] 7. **P6 blueprint/docs** — four densities + mixed rulers + the
  ...
  *Gate: build:site self-checks + SSR/wide/narrow walkthrough + OWNER
  VISUAL ACCEPTANCE.*
- [x] 8. **P0 closeout** — payload/manifest regen, combined suite +
