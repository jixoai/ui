<script lang="ts">
  ...
  // ── dev-HMR boilerplate, HAND-COPIED (arch-a) ── the official
  // example-sveltekit snippet (spike/ssg +layout.svelte): the virtual
  // runtime import keeps the dev <style data-stylex> fresh under HMR.
