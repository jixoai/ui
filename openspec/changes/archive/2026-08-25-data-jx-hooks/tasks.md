...
- [x] 3.2 DONE: verification.md finalized; Codex impl review r1 Block 7.5 → r2 Accept 9.0 (review-impl.md); archived.
      Original: verification.md with evidence; Codex implementation review;
      archive.
